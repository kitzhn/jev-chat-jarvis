...
- 最近互动时间
- 联系人之间的科幻节点关系网络
- GalGame 风格 3–4 个候选回复选项，一键写入输入框
- 显式重复联系人合并
- API 快速配置与自定义接口
...
候选回复现在以 GalGame 风格的 A / B / C（最多 4 个）选项卡展示。点击整张选项卡会直接把该回复写入聊天输入框并收起悬浮层；长按选项可复制。
